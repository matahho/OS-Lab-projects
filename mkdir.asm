...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    1053:	68 0f 18 00 00       	push   $0x180f
    1058:	6a 02                	push   $0x2
    ...
    13ac:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13d9:	0f b6 92 34 18 00 00 	movzbl 0x1834(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15d4:	eb 1a                	jmp    15f0 <printf+0x1a0>
          s = "(null)";
    15d6:	bb 2b 18 00 00       	mov    $0x182b,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1625:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
{
    ...
    1646:	73 10                	jae    1658 <free+0x38>
{
  ...
  freep = p;
    ...
    1671:	5b                   	pop    %ebx
  freep = p;
    1672:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
}
    1677:	5e                   	pop    %esi
    1678:	5f                   	pop    %edi
    1679:	5d                   	pop    %ebp
  ...
  freep = p;
    169a:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16c0:	8b 3d 2c 1b 00 00    	mov    0x1b2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1709:	8b 3d 2c 1b 00 00    	mov    0x1b2c,%edi
  ...
  return freep;
    1737:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    ...
    1764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1767:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
}
    ...
    base.s.ptr = freep = prevp = &base;
    1780:	c7 05 2c 1b 00 00 30 	movl   $0x1b30,0x1b2c
    1787:	1b 00 00 
    base.s.size = 0;
    178a:	bf 30 1b 00 00       	mov    $0x1b30,%edi
    base.s.ptr = freep = prevp = &base;
    178f:	c7 05 30 1b 00 00 30 	movl   $0x1b30,0x1b30
    1796:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    179b:	c7 05 34 1b 00 00 00 	movl   $0x0,0x1b34
    17a2:	00 00 00 
    if(p->s.size >= nunits){
